...
import com.theminesec.multiplatform.msa_core.feature.cardTapping.preAuth.presentation.PreAuthAction
import com.theminesec.multiplatform.msa_core.feature.cardTapping.preAuth.presentation.PreAuthState

@SuppressLint("UnrememberedMutableState")
@Composable
fun PreAuthScreen(
    state: PreAuthState,
    triggerAction: (PreAuthAction) -> Unit
                ...
                Box(
                    ...
                    Image(
                        ...
                        modifier = Modifier
                            ...
                            .clickable { triggerAction(PreAuthAction.OnBackClicked) }
                        //.align(Alignment.CenterStart)
                        ,
                        colorFilter = ColorFilter.tint(MsaTheme.colors.background)
                    )
                    Text(
                        text = stringResource(R.string.auth_pre_auth_label),
            ...
            Column {
                Column(
                    ...
                    MSAButton(
                        ...
                        onClick = {
                            triggerAction(
                                PreAuthAction.StartPreAuthRequest(
            ...
            Box(
                ...
                MSAPinPad(
                    ...
                    onValueChanged = {
                        println(
                            "Current amount: ${
                                displayAmount.formatAmountForDisplay(
                                    state.currency
                                )
                            }"
                        )
