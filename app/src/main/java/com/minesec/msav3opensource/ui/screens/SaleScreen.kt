...
import com.theminesec.multiplatform.msa_core.feature.cardTapping.sale.presentation.SaleAction
import com.theminesec.multiplatform.msa_core.feature.cardTapping.sale.presentation.SaleState
...
fun SaleScreen(
    ...
    var merchantNote by rememberSaveable { mutableStateOf("") }
                ...
                Box(
                    ...
                    Image(
                        ...
                        modifier = Modifier
                            ...
                            .clickable { triggerAction(SaleAction.OnBackClicked) }
